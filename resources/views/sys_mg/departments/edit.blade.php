...
@section('content')
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{route('departments.index')}}" class="btn btn-primary btn-sm">Back to Table</a>
    ...
    <form method="post" action="{{route('departments.update', $department->id)}}" class="col-md-6 mb-4">
