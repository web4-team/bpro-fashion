  ...
  <div class="col-lg-12 mb-4">
      ...
      <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <a href="{{route('cities.create')}}" class="btn btn-sm btn-primary">Create City</a>
        </div>
            ...
            <tbody>
              ...
              @foreach($cities as $city)
                    <tr>
                      ...
                      <td>
                      <a href="{{route('cities.edit', $city->id)}}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                        
                        <form method="post" style="display: inline-block" action="{{route('cities.destroy', $city->id)}}" onsubmit="return confirm('Are you sure?')">
                          @csrf
                          @method('DELETE')
