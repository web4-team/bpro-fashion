      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          ...
          <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('ab_payrolls.show', ['id' => $employee->id]) }}" class="btn btn-primary btn-sm">Back to Table</a>
...
<div class="row">
 <div class="col-sm-8 offset-sm-2">
  ...
  <div>
    ...
    @endif
    <form method="post" action="{{ route('ab_payrolls.store',['id'=>$employee->id])}}">
      @csrf
