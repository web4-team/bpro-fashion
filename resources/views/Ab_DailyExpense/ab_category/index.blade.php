...
<div class="col-sm-12">
  ...
  <div class="float-right">
    <a style="margin: 19px;" href="{{ route('ab_category.create')}}" class="btn btn-primary">New Category</a>
  </div>     
      ...
      <tr>
        ...
        <td>
          <div class="btn-group">
              ...
              <a href="{{ route('ab_category.edit',$row->id)}}" class="btn btn-primary btn btn-sm"><i class="fas fa-edit"></i></a>
            <form action="{{ route('ab_category.destroy', $row->id)}}" method="post" onsubmit="return confirm('Are you sure?')">
