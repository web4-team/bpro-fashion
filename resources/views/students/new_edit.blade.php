...
<!-- 	  <link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.css" rel="stylesheet">
			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					<div class="col-lg-6 col-7">
						<h6 class="h2 text-dark d-inline-block mb-0">New Create Form</h6>
	...
	<div class="row">
		...
		<form method="post" action="{{route('students.store')}}"class="card-body mb-4">
			@csrf
		
			<div class="mb-4 py-3 d-flex flex-row">
				<h1 class="m-0 font-weight-bold text-primary text-center">New Create Form</h1>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-5">
					...
					<input type="number" class="form-control text-dark " name="first" value="{{$student->first_paid}}"> 				

				</div>
				<div class="form-group float-right col-md-5">
					<label for="education" class="text-dark"><strong>Second Paid Amount</strong></label>
					<input type="number" class="form-control text-dark " name="second" value="{{$student->second_paid}}">		  
