...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
 ...
 <form action="{{route('ab_sale.search',['id' => $item->id])}}" method="POST">
          @csrf
<div class="row mb-4">
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card">
         ...
         Sale Lists
            ...
            <a href="{{ route('ab_sales.create', ['id'=>$item->id]) }}" class="btn btn-sm btn-primary">Create Sale</a>
                ...
                @php $i=1; @endphp
                  ...
                  @foreach($data_sale as $row)
                    ...
                    <td>{{$i++}}</td>	
                      ...
                      <td>
                         <div class="btn-group">
                        <a href="{{ route('ab_sales.edit', ['id' =>$row->id]) }}" class="btn btn-success btn btn-sm"><i class="fa fa-edit"></i></a>
                        <form action="{{ route('ab_sale.destroy', $row->id)}}" method="post" onsubmit="return confirm('Are you sure?')">
                          @csrf
                          @method('DELETE')
