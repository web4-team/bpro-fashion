        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h3 class="h2 text-dark d-inline-block mb-0">Add New Income</h3>
                        ...
                        <form action="{{ route('income.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <input type="text" id="expense_title" class="form-control" placeholder="Income Category" required="required" autofocus="autofocus" name="income_category">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <input type="number" step="any" id="expense_amount" min="0.01"  class="form-control" placeholder="Income Amount" required="required" name="income_amount">
                            ...
                            <div class="form-group">
                                <div class="form-label-group">
                                    ...
                                    <input type="date" id="expense_amount" class="form-control" placeholder="Income Date" required="required" name="income_date" value="{{ date('Y-m-d') }}">
                              ...
                              <div class="form-group">
                                <div class="form-label-group">
                                   ...
                                   <textarea class="form-control text-dark" name="income_remark" rows="3"></textarea>
