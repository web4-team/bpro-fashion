  ...
  <div class="col-lg-12 mb-4">
      ...
      <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          ...
          <a href="{{route('ab_divisions.create')}}" class="btn btn-sm btn-primary">Create Position</a>
        </div>
            ...
            <tbody>
              ...
              @foreach($divisions as $division)
                    <tr>
                      ...
                      <td>
                      <a href="{{route('ab_divisions.edit', $division->id)}}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                        
                        <form method="post" style="display: inline-block" action="{{route('ab_divisions.destroy', $division->id)}}" onsubmit="return confirm('Are you sure?')">
                          @csrf
                          @method('DELETE')
