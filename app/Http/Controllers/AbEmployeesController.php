...
class AbEmployeesController extends Controller
{
    ...
    {
        $employees = AbEmployee::all();
        return view('ab_employees.index')->with('employees',$employees);
    }
    ...
    {
        $states       = AbState::orderBy('state_name','asc')->get();
        $countries = AbCountry::orderBy('country_name','asc')->get();
        $cities = AbCity::orderBy('city_name','asc')->get();
        $divisions = AbDivision::orderBy('division_name','asc')->get();
        $genders = AbGender::orderBy('gender_name','asc')->get();
        $departments = AbDepartment::orderBy('dept_name','asc')->get();
       

        return view('ab_employees.create')->with([
            'genders'      => $genders,
            'states'       => $states,
            'countries'    => $countries,
            'cities'       => $cities,
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/ab_employees')->with('success','New Employee has been created!');
    }
    ...
    {
        $employee = AbEmployee::find($id);
        return view('ab_employees.show')->with('employee',$employee);
    }
    ...
    public function edit($id)
    {
        ...
        $employee = AbEmployee::find($id);
        return view('ab_employees.edit')->with([
            'departments'  => $departments,
            'countries'    => $countries,
            'cities'       => $cities,
            'states'       => $states,
    ...
    public function update(Request $request, $id)
    {
         ...
         */
        $this->setEmployee($employee,$request,$fileNameToStore);
        return redirect('/ab_employees')->with('success','Selected Employee has been updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        $employee->delete();
        Storage::delete('public/employee_images/'.$employee->picture);
        return redirect('/ab_employees')->with('success','Selected Employee has been deleted!');
    }
     ...
     * @return Boolean
     */
    private function setEmployee(AbEmployee $employee,Request $request,$fileNameToStore){
