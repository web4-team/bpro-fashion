...
class AbSaleController extends Controller
{
    /**
  ...
  public function create($id){
        $item = AbItem::findOrFail($id);
        return view('ab_sale.create')->with('item',$item);
    }

    public function downloadSale($id) {
        $item = Item::find($id);
        $sale=Sale::all();
        $sale_sum =Sale::all()->where('ab_item_id',$id)->sum('stock_out');
    ...
    public function store(Request $request, $id)
    {
        ...
        return redirect()->route('ab_sales.show',['id'=>$id]);
    }
    ...
    public function saleIndex($id){
       ...
       $data_sale=AbSale::where('ab_item_id',$id)->get();
        ...
        return view('ab_sale.sale',compact('item','data_sale'));
    }
    ...
    {
       $sale = AbSale::findOrFail($id);
        return view('ab_sale.edit')->with('sale',$sale);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('ab_sales.show',['id'=>$sale->ab_item_id]);
    }
    ...
    public function searchSale(Request $request, $id)
    {
        ...
        $data_sale=AbSale::where('ab_item_id',$id)->where('date','>=',$from_date)->where('date','<=',$to_date)->get();    
